...
<?php if($this->getParam('cookie_consent', '0') == 0) : ?>
...
<?php endif; ?>
<!-- gplus -->
<?php if(($this->getParam('google_plus', '1') == 1 || $this->getParam('google_plus_share', '1') == 1) && $option == 'com_content' && $view == 'article') : ?><gavern:social>
<?php if($this->getParam('cookie_consent', '0') == 0) : ?>
<script type="text/javascript">
<?php else : ?>
<script type="text/plain" class="cc-onconsent-social">
<?php endif; ?>
  window.___gcfg = {lang: '<?php echo $this->getParam("google_plus_lang", "en"); ?>'};
  (function() {
...
<?php endif; ?>
<!-- twitter -->
<?php if($this->getParam('tweet_btn', '0') == 1 && $option == 'com_content' && $view == 'article') : ?>
	<?php if($this->getParam('cookie_consent', '0') == 0) : ?>
...
<?php endif; ?>
<!-- Pinterest script -->
<?php if($this->getParam('pinterest_btn', '1') == 1 && $option == 'com_content' && $view == 'article') : ?><gavern:social>
	<?php if($this->getParam('cookie_consent', '0') == 0) : ?>
