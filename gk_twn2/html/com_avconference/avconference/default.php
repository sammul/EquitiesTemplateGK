...
<img src="/images/live4.png" style="position: absolute;right: 10px;top: 40px;" /> 
...
<?php if($user->authorize('avconference.allow_admin_interface', 'com_avconference')){ ?>
	...
	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="index_obj" width="100%" height="600"
			...
			<param name="bgcolor" value="#E8ECEF" />
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="allowFullScreen" value="true" />
			<param name="wmode" value="opaque" />
			<param name="base" value="<?php echo $base_URI;?>components/com_avconference/chat/">
			<embed src="<?php echo $base_URI;?>components/com_avconference/chat/<?php echo $avconference_admin_swf;?>" quality="high" bgcolor="#E8ECEF"
...
<?php }else{ ?>
	...
	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="index_obj" width="100%" height="600"
			codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab#version=11,1,0,0">
			<param name="movie" value="<?php echo $base_URI;?>components/com_avconference/chat/index.swf?randomVar=<?php echo $_SERVER['REQUEST_URI'] ?>" />
			<param name="quality" value="high" />
			<param name="bgcolor" value="#E8ECEF" />
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="allowFullScreen" value="true" />
			<param name="wmode" value="opaque" />
			<param name="base" value="<?php echo $base_URI;?>components/com_avconference/chat/">
			<embed src="<?php echo $base_URI;?>components/com_avconference/chat/index.swf?randomVar=<?php echo $_SERVER['REQUEST_URI'] ?>" quality="high" bgcolor="#E8ECEF"
				width="100%" height="600" name="index_embed" align="middle"
				play="true"
				loop="false"
				quality="high"
