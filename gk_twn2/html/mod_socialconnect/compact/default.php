...
?>
<div id="modSocialConnectContainer" class="socialConnectCompactLayout<?php if(!$services) { echo ' socialConnectNoServices';} ?>">
				...
				<div class="socialConnectInnerBlock">
					...
					<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
						<div class="socialConnectRow">
							<input id="modSocialConnectUsername" placeholder="<?php echo $usernameLabel; ?>" class="socialConnectInput" type="text" name="username" />
							<div class="socialConnectClearFix">
								<a class="socialConnectLink" href="<?php echo $remindUsernameLink; ?>"><?php echo JText::_('JW_SC_FORGOT_YOUR_USERNAME'); ?></a>
							</div>
						</div>
						<div class="socialConnectRow">
							<input id="modSocialConnectPassword" placeholder="<?php echo JText::_('JW_SC_PASSWORD') ?>" class="socialConnectInput" type="password" name="<?php echo $passwordFieldName; ?>" />
							<div class="socialConnectClearFix">
						...
						<div class="socialConnectRememberBlock">
							<label class="socialConnectLabel" for="modSocialConnectRemember"><?php echo JText::_('JW_SC_REMEMBER_ME') ?></label>
							<input id="modSocialConnectRemember" type="checkbox" name="remember" value="yes" />
						</div>
						<?php endif; ?>
