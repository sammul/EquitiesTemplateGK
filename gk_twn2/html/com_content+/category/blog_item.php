	...
	<?php if ($params->get('show_publish_date')) : ?>
			...
			<dd class="create">
              ...
              <time datetime="<?php echo JHtml::_('date', $this->item->publish_up, JText::_(DATE_W3C)); ?>">
			    ...
			    <?php echo JText::sprintf('COM_CONTENT_CREATED_DATE_ON', JHTML::_('date',$this->item->publish_up, JText::_('DATE_FORMAT_LC2'))); ?>
...
<div class="gkFeaturedItem">
    ...
    <p class="article-info">
        ...
        <?php if ($params->get('show_published_date')) : ?>
             ...
             <span class="published"><time datetime="<?php echo JHtml::_('date', $this->item->publish_up, JText::_(DATE_W3C)); ?>"><?php echo JText::sprintf('COM_CONTENT_PUBLISHED_DATE', JHTML::_('date',$this->item->publish_up, JText::_('DATE_FORMAT_LC2'))); ?></time></span>
	...
	<div class="gkFraturedItemContent">
	...
	<div class="gkFeaturedItemInfo">
		...
		<p><time datetime="<?php echo JHtml::_('date', $this->item->modified, JText::_(DATE_W3C)); ?>"><?php echo JText::sprintf('COM_CONTENT_LAST_UPDATED', JHTML::_('date',$this->item->modified, JText::_('DATE_FORMAT_LC2'))); ?></time></p>
