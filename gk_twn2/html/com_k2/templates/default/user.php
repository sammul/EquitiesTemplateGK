...
<div id="k2Container" class="userView<?php if ($this->params->get('pageclass_sfx')) echo ' ' . $this->params->get('pageclass_sfx'); ?>">
    ...
    <div class="col1k2js">
        <?php if ($this->params->get('userImage') && !empty($this->user->avatar)): ?>
            <img class="profilek2img" src="<?php echo $this->user->avatar; ?>" alt="<?php echo $this->user->name; ?>" style="width:<?php echo $this->params->get('userImageWidth'); ?>px; height:auto;" />
        <?php endif; ?>
        <!-- jomsocial Block  -->
        <div>
            <a><span class="buttonfollow"><img src="/images/icons/plus.png" /><?php echo JText::_('K2_USER_FOLLOW'); ?></span></a>
            <a><span class="buttonfollow"><img src="/images/icons/mail.png" /><?php echo JText::_('K2_MESSAGE'); ?></span></a>
            <ul class="listlinksjomsocial">
                <li><a href=""><img alt="<?php echo JText::_('K2_USER_FOLLOWERS'); ?>" src="/images/icons/followers.png" /><?php echo JText::_('K2_USER_FOLLOWERS'); ?></a></li>
                <li><a href=""><img alt="<?php echo JText::_('K2_USER_FOLLOWING'); ?>" src="/images/icons/following.png" /><?php echo JText::_('K2_USER_FOLLOWING'); ?></a></li>
                <li><a href=""><img alt="<?php echo JText::_('K2_USER_COMMENTS'); ?>" src="/images/icons/messages.png" /><?php echo JText::_('K2_USER_COMMENTS'); ?></a></li>
                <li><a href=""><img alt="<?php echo JText::_('K2_LIST_ARTICLES'); ?>" src="/images/icons/articles.png" /><?php echo JText::_('K2_LIST_ARTICLES'); ?></a></li>
            </ul>
            <div>
                <a href="http://twitter.com/" class="marginright"><img alt="tw" src="/images/icons/twitter.png" /></a>
                <a href="https://www.facebook.com/" class="marginright"><img alt="fb" src="/images/icons/facebook.png" /></a>
                <a href="http://www.youtube.com/user/" class="marginright"><img alt="gp" src="/images/icons/googleplus.png" /></a>
                <a href="http://www.linkedin.com/company/" class="marginright"><img alt="ln" src="/images/icons/linkedin.png"  /></a>
            </div>
        </div>
    </div>
    <!-- end col1 -->
    ...
    <div class="col2k2js">
        <div class="userName">
            <?php if ($this->params->get('userName')): ?>
                ...
                <?php //echo $this->user->profile->notes; ?>
            <?php endif; ?>
        </div>
        <div class="userListTitle">
            <h2 class="listTitle"><?php echo JText::_('K2_USER_ABOUT'); ?></h2>
        </div>
        <?php if ($this->params->get('userName') || $this->params->get('userDescription') || $this->params->get('userURL') || $this->params->get('userEmail')): ?>
            <div class="userBlock">
        ...
        <?php if (count($this->items)): ?>
            ...
            <div class="userItemList">
                <div class="userListTitle">
                    <h2 class="listTitle"><?php echo JText::_('K2_LIST_ARTICLES'); ?></h2>
                </div>
                        ...
                        <div class="userItemBody">
                            ...
                            <?php if ($this->params->get('userItemIntroText')): ?>
                                ...
                                <div class="userItemIntroText">
                                    ...
                                    <?php echo K2HelperUtilities::wordLimit(strip_tags($item->introtext, '<p><a><strong>'), 50) ?>
                                </div>
                            <?php endif; ?>
