...
<?php require_once (JPATH_COMPONENT_SITE . DS . 'helpers' . DS . 'k2.php'); ?>
...
<!-- <img src="<?php echo K2JomUtilities::getAvatar($my->id); ?>" class="cAvatar" /> -->
	</b>
	...
	<div class="cStream-Content status-creator">
		<ul class="creators cResetList cFloatedList clearfix">
			...
			<?php foreach($creators as $creator) { ?>
				<?php if(strcasecmp($creator->title, "videos") == 0)continue; ?>
		...
		<div class="creator-message-container">
			<textarea class="creator-message no-box-shadow"></textarea>
		</div>		
		...
		<div class="creator-actions clearfix">
			...
			<button class="creator-share cButton cButton-Black cFloat-R"><?php echo JText::_('COM_COMMUNITY_SHARE');?></button>
			<?php if($type=='profile'): 
