                    ...
                    <div class="cIndex-Box clearfix">
                        ...
                        <div class="cIndex-Content">
                            <h3 class="cIndex-Name cResetH">
                                <a href="<?php echo $row->profileLink . "#quote"; ?>"><?php echo $row->user->getDisplayName(); ?></a>
                            </h3>
                            <?php
							...
							<div class="cIndex-Actions">
								...
								<?php
									...
									?>
									<style>.cIndex-Content{min-height: 0 !important}</style>
									<?php
								}
								?>
                        </div>
                        <div class="cIndex-Content" style="margin-top:10px">
                            <?php $str =  $row->user->getInfo("FIELD_ABOUTME"); ?>
                            <?php // echo wordLimit($this->item->introtext, 50); ?>
                            <?php echo jcWordsLimit($str, 42); ?>
                        </div>
                    </div>
                </li>
            <?php endif; ?>
...
function jcWordsLimit($str, $limit = 100, $end_char = '&#8230;') {
    if (JString::trim($str) == '')
        return $str;
