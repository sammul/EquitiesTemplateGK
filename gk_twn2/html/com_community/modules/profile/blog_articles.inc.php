...
/**
 * @author: Fernando Villegas <webmaster.villegas at gmail dot com>
 * 
 * @copyright (c) 2013, V Labs 
 */
$blog_category = 109;
?>
	...
	<!--<h2 class="jomListTitle"><?php echo JText::_('COM_COMMUNITY_ARTICLES'); ?></h2>-->
	 <div class="writerdashboard-actions">
		 <ul>
			 ...
			 <li><a href="<?php echo JURI::base(); ?>community/profile?blogpublished=0#blog">Submitted</a></li>
