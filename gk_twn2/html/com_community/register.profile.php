...
<style>
	.one-col .label, .lblradio-block{display:block}
...
?>
		<div class="ctitle">
			<h2><?php echo ($field_i==1?"Step 2: ".JText::_("COM_COMMUNITY_PERSONAL_DETAILS"):JText::_( $fieldName )); ?></h2>
		</div>
...
<?php
		foreach($group->fields as $field )
		{
			...
			$part1 = in_array($field->name, array("Best Description", "Interests", "Trading Frequency"))?"one-col":""; 
			$part2 = ($field->name=="Gender")?"samerow":"";
?>
				<li class="<?php echo $part1; ?>">
					<label id="lblfield<?php echo $field->id;?>" for="field<?php echo $field->id;?>" class="form-label <?php echo $part2; ?>"><?php if($field->required == 1) echo '*'; ?><?php echo JText::_($field->name); ?></label>
					<div class="form-field <?php echo $part2; ?>">
						<?php echo $html; ?>
