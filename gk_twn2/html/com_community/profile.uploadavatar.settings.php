...
?>
<?php if($session->get('jom_user_type', "") == 'issuer'): ?>
<style>
	.show-thumbnail{display: none}
	.app-box-footer-custom{display:none}
</style>
<?php endif; ?>
<div class="cLayout cProfile-UploadAvatar">
	...
	<div class="skipLink">
		<p>
			<a href="<?php echo $skipLink; ?>"class="cButton cButton-Blue saveButton"><?php echo JText::_('COM_COMMUNITY_SKIP_UPLOAD_AVATAR'); ?></a>
		</p>
	</div>
	<?php } ?>
	...
	<div class="app-box upload-avatar">
		<form name="jsform-profile-uploadavatar" action="/community/profile/uploadavatar" id="uploadForm" method="post" enctype="multipart/form-data">
			<input type="file" id="file-upload" name="Filedata" />
			<input class="cButton" size="30" type="submit" id="file-upload-submit" value="<?php echo JText::_('COM_COMMUNITY_BUTTON_UPLOAD_PICTURE'); ?>">
		...
		<div class="app-box-footer">
			<a href="javascript:void(0);" onclick="joms.profile.confirmRemoveAvatar();" class="cButton cButton-Black"><?php echo JText::_('COM_COMMUNITY_REMOVE_PROFILE_PICTURE');?></a>
		</div>
		<?php } ?>
	</div>
	...
	<div class="app-box show-avatar">
		...
		<?php /*?><div class="app-box-footer">
			<?php
			if (!$firstLogin)
			{
			?>
				<a href="javascript:updateThumbnail()" id="update-thumbnail" class="cButton cButton-Blue"><?php echo JText::_('COM_COMMUNITY_UPDATE_THUMBNAIL'); ?></a>
				<a href="javascript:saveThumbnail()" id="update-thumbnail-save" class="cButton cButton-Green" style="display:none"><?php echo JText::_('COM_COMMUNITY_THUMBNAIL_SAVE'); ?></a>
			<?php
			}
			else
			{
	...
	<div class="app-box show-thumbnail">
		...
		<div class="app-box-content">
			<img id="thumbnail-profile-pic" height="64" width="64" src="<?php echo $user->getThumbAvatar();?>" alt="" title="" />
		</div>
		<div class="clear"></div>
	</div>
	<div class="app-box-footer-custom">
      <?php
      if (!$firstLogin)
      {
      ?>
         <a href="javascript:updateThumbnail()" id="update-thumbnail" class="cButton cButton-Blue"><?php echo JText::_('COM_COMMUNITY_UPDATE_THUMBNAIL'); ?></a>
         <a href="javascript:saveThumbnail()" id="update-thumbnail-save" class="cButton cButton-Green" style=""><?php echo JText::_('COM_COMMUNITY_THUMBNAIL_SAVE'); ?></a>
      <?php
      }
      else
      {
      ?>
         <a style="float:right;" href="<?php echo $skipLink; ?>"class="cButton cButton-Blue cButton-Blue-new saveButton"><span><?php echo JText::_('COM_COMMUNITY_SAVE'); ?></span></a>
      <?php
      }
      ?>
      <div id="update-thumbnail-guide"><?php echo JText::_('COM_COMMUNITY_UPDATE_THUMBNAIL_GUIDE'); ?></div>
   </div>
