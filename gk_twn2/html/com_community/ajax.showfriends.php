...
<ul class="cTabNav">
	...
	<li style="display:none!important" id="ctab-selected" onclick="joms.invitation.showSelected();"><a href="#community-invited"><?php echo JText::_('COM_COMMUNITY_INVITATION_SELECTED_FRIENDS');?></a></li>
</ul>
