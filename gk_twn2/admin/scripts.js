	...
	$$('.panel h3.title').each(function(panel) {
		...
		panel.addEvent('click', function(){
			...
			if(panel.hasClass('pane-toggler')) {
				...
				(function() { var myFx = new Fx.Scroll(window, { duration: 150 }).toElement(panel); }).delay(250);
...
function getUpdates() {    
     ...
     var update_url = 'https://www.gavick.com/updates/json/tmpl,component/query,product/product,gk_twn2_j16';
